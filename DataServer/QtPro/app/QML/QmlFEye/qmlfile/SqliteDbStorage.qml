...
Item
{
    ...
    property string m_str_sql_create_table_TABLE_USERSTOCK : "CREATE TABLE IF NOT EXISTS TABLE_USERSTOCK(C_INDEX INTEGER PRIMARY KEY, m_s_Symbol TEXT, m_n_Name TEXT)";
    property string m_str_sql_delete_from_TABLE_USERSTOCK : "DELETE FROME TABLE_USERSTOCK  WHERE C_INDEX == 1";
    property string m_str_sql_select_TABLE_USERSTOCK_001 : "SELECT C_INDEX,m_s_Symbol,m_n_Name FROM TABLE_USERSTOCK";
    property string m_str_sql_insert_TABLE_USERSTOCK_001 : "INSERT INTO TABLE_USERSTOCK(C_INDEX, m_s_Symbol, m_n_Name) VALUES(?,?,?)";
