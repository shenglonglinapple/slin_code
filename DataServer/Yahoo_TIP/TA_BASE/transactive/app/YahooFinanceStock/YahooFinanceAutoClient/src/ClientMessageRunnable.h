#ifndef __CLASS_CLIENT_MESSAGE_RUNNABLE_H__
#define __CLASS_CLIENT_MESSAGE_RUNNABLE_H__
...
class CClientMessageRunnable : public QRunnable
{
public:
	CClientMessageRunnable(qint32 nHanle, QByteArray* pMessage);
	~CClientMessageRunnable();
protected:
...
private:
	...
	void _ProcessMessage_ReqHoldAccount();
private:
	...
	void _ProcessMessage_AckHoldAccount();

private:
	qint32 m_nHanle;
	QByteArray* m_pMessage; 
	CClientMessageProcesser* m_pMessageProcesser;
};

#endif//__CLASS_CLIENT_MESSAGE_RUNNABLE_H__
