...
CClientMessageRunnable::CClientMessageRunnable(qint32 nHanle, QByteArray* pMessage)
{
	m_nHanle = 0;
	m_pMessage = NULL;
	...
	m_nHanle = nHanle;
	m_pMessage = pMessage;
	m_pMessageProcesser = new CClientMessageProcesser(m_nHanle);
}

CClientMessageRunnable::~CClientMessageRunnable()
{
	if (NULL != m_pMessage)
	{
		delete m_pMessage;
...
void CClientMessageRunnable::run()
{
...
void CClientMessageRunnable::_ProcessMessage()
{
	MYLOG4CPP_DEBUG<<" "
...
void CClientMessageRunnable::_ProcessMessage_Req(qint32 nMessageType, qint32 nDataType )
{
...
void CClientMessageRunnable::_ProcessMessage_ReqLogin()
{
	CReqLogin* pReq = NULL;
	pReq = new CReqLogin();
...
void CClientMessageRunnable::_ProcessMessage_ReqLogout()
{
...
void CClientMessageRunnable::_ProcessMessage_ReqSynYahoo()
{
...
void CClientMessageRunnable::_ProcessMessage_ReqDownLoadStock()
{
...
void CClientMessageRunnable::_ProcessMessage_ReqStockMinTimeMaxTime()
{
...
void CClientMessageRunnable::_ProcessMessage_ReqStockHistoryData()
{
...
void CClientMessageRunnable::_ProcessMessage_ReqCreateUser()
{
...
void CClientMessageRunnable::_ProcessMessage_ReqTrade()
{
	CReqTrade* pReq = NULL;
	pReq = new CReqTrade();
	pReq->setValue(m_pMessage);
...
void CClientMessageRunnable::_ProcessMessage_ReqHistoryTrade()
{
...
void CClientMessageRunnable::_ProcessMessage_ReqAccount()
{

}
void CClientMessageRunnable::_ProcessMessage_ReqHoldAccount()
{
...
//////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////
void CClientMessageRunnable::_ProcessMessage_Ack(qint32 nMessageType, qint32 nDataType )
{
...
void CClientMessageRunnable::_ProcessMessage_AckLogin()
{
	CAckLogin* pAck = NULL;
	pAck = new CAckLogin();
...
void CClientMessageRunnable::_ProcessMessage_AckLogout()
{
...
void CClientMessageRunnable::_ProcessMessage_AckSynYahoo()
{
...
void CClientMessageRunnable::_ProcessMessage_AckDownLoadStock()
{
...
void CClientMessageRunnable::_ProcessMessage_AckStockMinTimeMaxTime()
{
...
void CClientMessageRunnable::_ProcessMessage_AckStockHistoryData()
{
...
void CClientMessageRunnable::_ProcessMessage_AckCreateUser()
{
...
void CClientMessageRunnable::_ProcessMessage_AckTrade()
{
	CAckTrade* pAck = NULL;
	pAck = new CAckTrade();
	pAck->setValue(m_pMessage);
...
void CClientMessageRunnable::_ProcessMessage_AckHistoryTrade()
{
...
void CClientMessageRunnable::_ProcessMessage_AckAccount()
{
...
void CClientMessageRunnable::_ProcessMessage_AckHoldAccount()
{
