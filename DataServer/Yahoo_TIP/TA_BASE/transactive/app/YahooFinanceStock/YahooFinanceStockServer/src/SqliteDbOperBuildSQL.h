...
public:
	...
	QString buildSQL_Select_TABLE_USER_HOLD_ACCOUNT(const QString& strUserID);
	QString buildSQL_Select_TABLE_USER_HOLD_ACCOUNT(const QString& strUserID, const QString& strSymbolUse);
