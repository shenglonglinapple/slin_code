...
CAckCreateUser::CAckCreateUser( void )
{
	_Clear();
}
...
//static
bool CAckCreateUser::checkMsgDataType( qint32 nMessageType, qint32 nDataType )
{
	bool bFunRes = false;
...
QByteArray* CAckCreateUser::getMessage()
{
...
void CAckCreateUser::setValue(const QByteArray* pMessage )
{
