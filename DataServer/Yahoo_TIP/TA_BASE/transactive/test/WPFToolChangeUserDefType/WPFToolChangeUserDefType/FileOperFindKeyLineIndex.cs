...
{
    class FileOperFindKeyLineIndex
    {

        private LineOperFindKeyIndex m_LineFindKeyIndex;
        ...
        public System.Int32 findKeyLineIndex(System.String strFullPath, System.String strFindKey)
        {
            ...
            {
                //check each line
                nKeyInLineIndex = m_LineFindKeyIndex.findUPKeyIndexInUPLine(strGetLineSrc, strFindKey);
