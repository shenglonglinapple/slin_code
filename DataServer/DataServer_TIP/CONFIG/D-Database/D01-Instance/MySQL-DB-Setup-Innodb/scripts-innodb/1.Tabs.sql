...
alter table ti_display_request drop column led_background_colour;
alter table ti_display_request drop column plasma_font_size;
alter table ti_display_request drop column plasma_font_type;
alter table ti_display_request drop column plasma_foreground_colour;
alter table ti_display_request drop column plasma_background_colour;
alter table ti_display_request add (lcd_font_size  int);
alter table ti_display_request add (lcd_font_colour  int);
...
-- DTL-Rights-DisplayOnly
ALTER TABLE SE_ACTION ADD column IS_DISPLAY_ONLY tinyint(1) DEFAULT 0;	

-- DTL-ECS-ATS-R1
ALTER TABLE AT_FIXED_BLOCK_MAP ADD column ARM_ID tinyint(1) DEFAULT 0 NOT NULL;

-- DTL-MySQL-MainTain-01
ALTER TABLE `adm_sequence` ADD PRIMARY KEY (`PKEY`),
 DROP INDEX `idx_adm_seq_name`,
 ADD UNIQUE INDEX `idx_adm_seq_name` USING BTREE(`NAME`);
