/*=====================================================
Version: DTL-DataSync-06-11-MySQL
-----------

number of scripts: 3
scripts name:
1.DTL-DataSync-06-11-MySQL-Main.sql		-- Main script to call other script(s).
2.DTL-DataSync-06-11-MySQL-prc_enqueue.sql	-- Update prc_enqueue.
3.DTL-DataSync-06-11-MySQL-prc_enqueue_notrans.sql	-- Update prc_enqueue_notrans.
...
source DTL-DataSync-06-11-MySQL-Main.sql
...
# mysql --comments -h[DBserver_hostname] -u[user] -p[passwd] -D[DB_Name] 
mysql> SELECT if(count(*)=2,1,0) value FROM information_schema.ROUTINES R where routine_name in ('prc_enqueue','prc_enqueue_notrans') and routine_schema=database();
========================================================*/
