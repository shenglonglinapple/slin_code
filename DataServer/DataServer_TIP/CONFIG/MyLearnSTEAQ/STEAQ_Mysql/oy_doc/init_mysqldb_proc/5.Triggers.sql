...
#       OPEN cu_session(:NEW.sessionkey);
#        FETCH cu_session INTO p_session_location,p_profile_id;
#       CLOSE cu_session;
...
/*
      IF(p_alarm_type_key IN('50008','50009','50010'))THEN         --IF THE ALARM_TYPE in DPGENERAL,DPTRUE,DPFALSE
         p_alarm_desc :=:NEW.description;
         p_alarm_value:= v_dp_param_list;
      ELSE
           p_alarm_desc :=:NEW.description;
         p_alarm_value:= p_alarm_type_name||' '||v_dp_param_list;
      END IF;
*/
      IF(p_alarm_type_key IN('50011','50012','50013','50014','50015','50016'))THEN         #IF THE ALARM_TYPE in OH, VH, HI, LO, VL, OL
...
BEGIN
	...
	the_loop: LOOP
		...
		INSERT INTO se_operator_regions( seoreg_id, operatorkey, seregi_id ) values ( seq_nextval('SECURITY_SEQ'), NEW.pkey, v_nseregi_id );
