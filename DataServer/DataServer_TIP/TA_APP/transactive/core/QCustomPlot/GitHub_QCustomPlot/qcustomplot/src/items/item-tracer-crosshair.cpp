...
*/
void QCPItemTracerCrossHair::setSize(double size)
{
  mSize = size;
}
...
/*!
  ...
  \see setGraphKey
*/
void QCPItemTracerCrossHair::setGraph(QCPGraph *graph)
{
  if (graph)
  {
...
*/
void QCPItemTracerCrossHair::setGraphKey(double key)
{
  mGraphKey = key;
}
...
*/
void QCPItemTracerCrossHair::setInterpolating(bool enabled)
{
...
*/
void QCPItemTracerCrossHair::updatePosition()
{
  if (mGraph)
  {
