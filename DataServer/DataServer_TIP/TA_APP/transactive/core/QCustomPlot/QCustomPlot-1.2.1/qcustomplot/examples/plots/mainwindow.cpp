...
void MainWindow::setupDemo(int demoIndex)
{
  switch (demoIndex)
  {
    case 0:  setupQuadraticDemo(this->customPlot); break;
    case 1:  setupSimpleDemo(this->customPlot); break;
    case 2:  setupSincScatterDemo(this->customPlot); break;
    case 3:  setupScatterStyleDemo(this->customPlot); break;
    case 4:  setupScatterPixmapDemo(this->customPlot); break;
    case 5:  setupLineStyleDemo(this->customPlot); break;
    case 6:  setupDateDemo(this->customPlot); break;
    case 7:  setupTextureBrushDemo(this->customPlot); break;
    case 8:  setupMultiAxisDemo(this->customPlot); break;
    case 9:  setupLogarithmicDemo(this->customPlot); break;
    case 10: setupRealtimeDataDemo(this->customPlot); break;
    case 11: setupParametricCurveDemo(this->customPlot); break;
    case 12: setupBarChartDemo(this->customPlot); break;
    case 13: setupStatisticalDemo(this->customPlot); break;
    case 14: setupSimpleItemDemo(this->customPlot); break;
    case 15: setupItemDemo(this->customPlot); break;
    case 16: setupStyledDemo(this->customPlot); break;
    case 17: setupAdvancedAxesDemo(this->customPlot); break;
    case 18: setupColorMapDemo(this->customPlot); break;
...
void MainWindow::allScreenShots()
{
  ...
  if (currentDemoIndex < 18)
  {
    ...
    this->customPlot = new QCustomPlot(this->centralWidget);
...
void MainWindow::setupMyTestOneDemo(QCustomPlot *customPlot)
{
...
void MainWindow::setupMyTestTwoDemo(QCustomPlot *customPlot)
{
	demoName = "My Test One Demo";
	...
	QBrush boxBrush(QColor(0, 255, 0, 255));//green
	QPen boxPen(QColor(0, 255, 0, 255));//green
	//boxBrush.setStyle(Qt::SolidPattern); // make it look oldschool Qt::SolidPattern  Qt::Dense6Pattern
	sample1->setBrush(boxBrush);
	sample1->setPen(boxPen);

	// set data:
	sample1->setKey(1);
	sample1->setMinimum(1);
	sample1->setLowerQuartile(2);
	sample1->setMedian(2);
	sample1->setUpperQuartile(4);
	sample1->setMaximum(9);

	sample1->setWidth(0.1);//矩形宽度
	sample1->setWhiskerWidth(0);//上顶，下底 直线宽度
	sample1->setWhiskerPen(boxPen);
	sample1->setWhiskerBarPen(boxPen);
	sample1->setMedianPen(boxPen);
	

	// prepare axes:
	customPlot->yAxis->setLabel(QString::fromUtf8("yAxis setLabel"));
	//customPlot->rescaleAxes();
...
void MainWindow::setupMyTestThreeDemo(QCustomPlot *customPlot)
{
	demoName = "My Test One Demo";
