        ...
        MouseArea
        {
            ...
            onClicked:
            {
                console.log('TotalStockListDelegate.qml',
                            ...
                            ' ','m_TotalStockListView.currentIndex:', m_TotalStockListView.currentIndex,
                            ' ','new index:', index);
                ...
                // 获取 Id 与 name
                //set value and emit
                m_CurrentUserStockData.m_s_Symbol_current = m_TotalStockListView.model.get(m_TotalStockListView.currentIndex).m_s_Symbol;
                m_CurrentUserStockData.m_s_Symbol_Extern_current = m_TotalStockListView.model.get(m_TotalStockListView.currentIndex).m_s_Symbol_Extern;
