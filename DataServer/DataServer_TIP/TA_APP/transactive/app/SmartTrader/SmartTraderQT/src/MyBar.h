...
typedef std::set<CMyBar> CMyBars;
//typedef std::auto_ptr<Bars> BarsPtr;
//typedef CMyBars* CMyBarsPtr;
typedef std::auto_ptr<CMyBars> CMyBarsPtr;
...
public:
	CMyBarsPtr convertValue(const std::list<CHistoryData*>& lstHistoryData);
