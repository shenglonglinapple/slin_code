...
int CBoostLogger::testBoostLog()
{
	...
	LOG_TRACE<<"BoostLogTest LOG_TRACE";
	LOG_DEBUG<<"BoostLogTest LOG_DEBUG";
	LOG_INFO<<"BoostLogTest LOG_INFO";
	LOG_WARNING<<"BoostLogTest LOG_WARNING";
	LOG_ERROR<<"BoostLogTest LOG_ERROR";
	LOG_FATAL<<"BoostLogTest LOG_FATAL";
