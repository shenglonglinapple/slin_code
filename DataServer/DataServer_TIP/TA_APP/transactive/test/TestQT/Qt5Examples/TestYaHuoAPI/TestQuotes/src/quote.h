...
namespace quote
{
	...
	inline std::string getLatestQuotesCsv(const std::string &instruments, std::list<QuoteType> quoteTypes);
...
//     inline std::string getLatestQuotesCsv(const std::string &instruments);
    ...
    inline std::string getHistoricalQuotesCsv(const std::string &instrument, 
	...
	{
        return detail::core::getHistoricalQuotesCsv(instrument, 
			startYear, startMonth, startDay, 
			endYear, endMonth, endDay, 
			detail::conversion::getString(rangeType));
    }
}
