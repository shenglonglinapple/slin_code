...
void DataAccessException::logInfo(const std::string& file, int line)
{
	BOOST_LOG_SEV(g_logHandleFile, trivial::error)<<" ["<<file<<":"<<line<<"] "<<"DataAccessException Info:"<<getErrorMsg();
}
