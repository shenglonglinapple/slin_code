...
void  SQLFileHelper::getSQLString(const std::string& strSQLKey, SQLStatement& rSqlStatements)
{
	...
	rSqlStatements.m_strSQLID  = strSQLKey;
	rSqlStatements.m_strCommonSQL = s_SQLArray[nIndex].pCommonSQL;
	rSqlStatements.m_strOracleSQL  = s_SQLArray[nIndex].pOracleSQL;
	rSqlStatements.m_strMySQLSQL  = s_SQLArray[nIndex].pMySQLSQL;
	rSqlStatements.m_strSQLiteSQL = s_SQLArray[nIndex].pSQLiteSQL;
