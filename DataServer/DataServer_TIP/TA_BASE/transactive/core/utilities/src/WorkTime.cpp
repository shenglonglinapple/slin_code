...
BigInt64 CWorkTimeLock::getNotWorkTimeMillSeconds()
{
	BigInt64 nFunRes = 0;
	boost::posix_time::ptime fTimeNow;
...
BigInt64 CWorkTimeLock::getWorkTimeMillSeconds()
{
	BigInt64 nFunRes = 0;
	boost::mutex::scoped_lock lock(m_lockWorkTime);
	nFunRes = getTimeMilliseconds(&m_nWorkTime);
...
TA_Base_Core::BigInt64 CWorkTimeLock::getWorkTimeSeconds()
{
	BigInt64 nFunRes = 0;
	boost::mutex::scoped_lock lock(m_lockWorkTime);
	nFunRes = getTimeSeconds(&m_nWorkTime);

	return nFunRes;
}

TA_Base_Core::BigInt64 CWorkTimeLock::getNotWorkTimeSeconds()
{
	BigInt64 nFunRes = 0;
	boost::posix_time::ptime fTimeNow;
	...
	nFunRes = getTimeSeconds(&m_nNotWorkTime);
...
BigInt64 CWorkTimeNoLock::getNotWorkTimeMillSeconds()
{
	BigInt64 nFunRes = 0;
	boost::posix_time::ptime fTimeNow;
...
BigInt64 CWorkTimeNoLock::getWorkTimeMillSeconds()
{
	BigInt64 nFunRes = 0;
	nFunRes = getTimeMilliseconds(&m_nWorkTime);
...
TA_Base_Core::BigInt64 CWorkTimeNoLock::getWorkTimeSeconds()
{
	BigInt64 nFunRes = 0;
	nFunRes = getTimeSeconds(&m_nWorkTime);
...
TA_Base_Core::BigInt64 CWorkTimeNoLock::getNotWorkTimeSeconds()
{
	BigInt64 nFunRes = 0;
	boost::posix_time::ptime fTimeNow;
