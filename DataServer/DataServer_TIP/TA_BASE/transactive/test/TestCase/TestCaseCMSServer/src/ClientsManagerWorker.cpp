...
{	
	...
	m_nCfg_ClientCount = CConfigInfo::getInstance().getClientCount();
...
void CClientsManagerWorker::_CreateALLClient()
{
	...
	for (int nIndex = 0; nIndex < m_nCfg_ClientCount; nIndex++)
	{
		...
		LOG_INFO<<"CClientsManagerWorker new CClientManager"
