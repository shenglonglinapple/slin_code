...
public:
	...
	virtual BigInt64 getWorkTimeSeconds()= 0;
	virtual BigInt64 getWorkTimeMillSeconds()= 0;

	//NotWorkTime valuse is now time - begin work time
	virtual BigInt64 getNotWorkTimeSeconds()= 0;//for monitor 
	virtual BigInt64 getNotWorkTimeMillSeconds()= 0;//for monitor 
public:
...
public:	
	...
	virtual BigInt64 getWorkTimeSeconds();   //for log time 
	virtual BigInt64 getWorkTimeMillSeconds();   //for log time 
	virtual BigInt64 getNotWorkTimeSeconds(); //for monitor	
	virtual BigInt64 getNotWorkTimeMillSeconds(); //for monitor	
private:
