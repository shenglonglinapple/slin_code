...
public:
	std::string mysys_boost_DataTimeToStr(time_t nTimeValue);
	time_t mysys_boost_StrToDateTime(const std::string& strTimeValue);
public:
...
private:
	std::string _GetTimeString(boost::posix_time::ptime* pfbtime);
