...
//////////////////////////////////////////////////////////////////////////
const std::string DEF_PARAM_RPARAM_PROJECTCFGFILE = "RPARAM_PROJECTCFGFILE";//ProjectCfgFile=./cfg/cfdServerConfigfile.cfg
const std::string DEF_PARAM_RPARAM_DBCONNECTIONFILE = "RPARAM_DBCONNECTIONFILE";//RPARAM_DBCONNECTIONFILE=./cfg/ConnectionString.xml
//////////////////////////////////////////////////////////////////////////
const std::string DEF_VALUE_String_ParamKeyValue_Separator = "=";

//////////////////////////////////////////////////////////////////////////
const std::string DEF_PARAM_RPARAM_PROJECTCFGFILE_Value= "./cfg/cfdServerConfigfile.cfg";
const std::string DEF_PARAM_RPARAM_DBCONNECTIONFILE_Value= "./cfg/ConnectionString.xml";
