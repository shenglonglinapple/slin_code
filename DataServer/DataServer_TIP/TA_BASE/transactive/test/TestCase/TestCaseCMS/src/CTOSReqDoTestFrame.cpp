...
int CTOSReqDoTestFrame::checkValue()
{
	...
	if (m_nFrameType_SampleValue != m_nFrameType)
	{
		LOG_ERROR<<"checkValue Error!"
			<<" "<<"m_nFrameType_SampleValue="<<m_nFrameType_SampleValue
	...
	{
		LOG_ERROR<<"checkValue Error!"
			<<" "<<"m_nDoTestType_SampleValue="<<m_nDoTestType_SampleValue
	...
	{
		LOG_ERROR<<"checkValue Error!"
			<<" "<<"m_strReqInfo_SampleValue="<<m_strReqInfo_SampleValue
	...
	{
		LOG_ERROR<<"checkValue Error!"
			<<" "<<"m_id_SampleValue="<<m_id_SampleValue
			<<" "<<"m_id="<<m_id;
		LOG_ERROR<<"checkValue Error!";
		nFunRes = -1;
		return nFunRes;
	...
	{
		LOG_ERROR<<"checkValue Error!"
			<<" "<<"m_securityType_SampleValue="<<m_securityType_SampleValue
	...
	{
		LOG_ERROR<<"checkValue Error!"
			<<" "<<"m_code_SampleValue="<<m_code_SampleValue
			<<" "<<"m_code="<<m_code;
		LOG_ERROR<<"checkValue Error!";
		nFunRes = -1;
		return nFunRes;
	...
	{
		LOG_ERROR<<"checkValue Error!"
			<<" "<<"m_symbol_SampleValue="<<m_symbol_SampleValue
			<<" "<<"m_symbol="<<m_symbol;
		LOG_ERROR<<"checkValue Error!";
		nFunRes = -1;
		return nFunRes;
	...
	{
		LOG_ERROR<<"checkValue Error!"
			<<" "<<"m_securityId_SampleValue="<<m_securityId_SampleValue
			<<" "<<"m_securityId="<<m_securityId;
		LOG_ERROR<<"checkValue Error!";
		nFunRes = -1;
		return nFunRes;
	}
	...
	{
		LOG_ERROR<<"checkValue Error!"
			<<" "<<"m_securityExchange_SampleValue="<<m_securityExchange_SampleValue
	...
	{
		LOG_ERROR<<"checkValue Error!"
			<<" "<<"m_tickSize_SampleValue="<<m_tickSize_SampleValue
	...
	{
		LOG_ERROR<<"checkValue Error!"
			<<" "<<"m_tickValue_SampleValue="<<m_tickValue_SampleValue
	...
	{
		LOG_ERROR<<"checkValue Error!"
			<<" "<<"m_decimalPlace_SampleValue="<<m_decimalPlace_SampleValue
	...
	{
		LOG_ERROR<<"checkValue Error!"
			<<" "<<"m_maturityDate_SampleValue="<<m_maturityDate_SampleValue
