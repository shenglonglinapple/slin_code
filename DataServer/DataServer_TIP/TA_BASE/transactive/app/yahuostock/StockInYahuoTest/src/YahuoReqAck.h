#ifndef __CLASS_YAHUO_REQACK_H__
#define __CLASS_YAHUO_REQACK_H__
...
public:
	static std::string getString(RangeType rangeType);
	static std::string getString(QuoteType quoteType);
